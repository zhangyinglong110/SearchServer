...
public class CallBackServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (code != null && state != null) {
			...
			// 存储微信令牌信息的实体类
			WeiChatInfo weiChatInfo = JsonUtil.getWeiChat(jsonString);
			...
			WeiXinUserInfo weiXinUserInfo = JsonUtil.getWeiXinUserInfo(weiUseString);
			...
			resp.sendRedirect("index.jsp?uid=" + weiXinUserInfo.getUnionid() + "&tid=" + nick);
		} else {
