...
public class CityMap {
	...
	static {
		...
		model.put("京津冀", new String[] { "请选择","北京中关村", "北京国贸校区", "北京通州", "北京回龙观", "北京艾特", "翡翠昌平", "天津南开", "天津新安", "石家庄民族路" });
		model.put("上海区", new String[] { "请选择","完美上海虹口区东江湾", "卓新上海虹口区东江湾校区", "上海徐汇", "上海珠洲口", "上海浦东" });
		model.put("西北区",
				new String[] { "请选择","完美先雁塔区小寨校区", "卓新智趣西安第二分公司", "西安华融", "西安太白", "西安钟楼", "太原小店", "太原长风街", "郑州金水", "郑州国泰" });
		...
		model.put("华南区", new String[] { "请选择","深圳华强北", "深圳罗湖", "深圳福田", "广州黄埔", "广州元岗", "广州长兴", "柳州广场路", "南宁西乡塘", "福州台江" });
